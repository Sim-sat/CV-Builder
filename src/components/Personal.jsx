...
function Personal({nameChange, emailChange, phoneChange, adressChange}){
    return (
    <div className='text-xs content-center bg-white  ml-5 p-5 rounded-2xl mb-5 flex-grow'  >
        ...
        <form>
            ...
            id="name" placeholder='First and last name' className="m-2 w-full rounded-xl bg-slate-100 p-2 text-base text-base/1" type="text"></input><br></br>
